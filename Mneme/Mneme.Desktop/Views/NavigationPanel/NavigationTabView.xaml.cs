...
{
	public NavigationTabView() => InitializeComponent();
	...
	private void Button_Click(object sender, RoutedEventArgs e) => RaiseEvent(new RoutedEventArgs(ItemClickedEvent, this));
}
